...
struct mat2
{
    ...
    mat2(float64 _f) { for (size_t i = 0; i < ROWS; i++) for (size_t j = 0; j < COLUMNS; j++) data[j][i] = _f; }
    mat2(float64 _f00, float64 _f10,
         float64 _f01, float64 _f11)
         {
    ...
    mat2 operator-(const mat2& _m) const { mat2 _tMat2; for (size_t i = 0; i < COLUMNS * ROWS; i++) _tMat2.array[i] = _m.array[i] - array[i]; return _tMat2; }
    void operator-=(const mat2& _m) { for (size_t i = 0; i < COLUMNS * ROWS; i++) array[i] -= _m.array[i]; }
    mat2 operator*(const float64 _s) const { mat2 _tMat2; for (size_t i = 0; i < COLUMNS * ROWS; i++) _tMat2.array[i] = array[i] * _s; return _tMat2; }
    ...
    void setCR(float64 _f00, float64 _f10,
               float64 _f01, float64 _f11)
               {
                   data[0][0] = _f00; data[0][1] = _f01;
                   data[1][0] = _f10; data[1][1] = _f11;
    ...
    void setRC(float64 _f00, float64 _f01,
               float64 _f10, float64 _f11)
               {
                   data[0][0] = _f00; data[0][1] = _f01;
                   data[1][0] = _f10; data[1][1] = _f11;
               }
